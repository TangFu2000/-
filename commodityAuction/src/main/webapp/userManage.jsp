<%--&lt;%&ndash;<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core_1_1" %>&ndash;%&gt;--%>
                        ...
                        <div id="dv1">
                            <table class="table" id="tbRecord">
                                ...
                                <c:if test="${not empty requestScope.pageBean.list}">
                                    <c:forEach items="${requestScope.pageBean.list}" var="buyer">
                                        <tbody id="by">
                                            <tr>
                                                <td>${buyer.buyerId}</td>
                                                ...
                                                <td>${buyer.balance}</td>
                                                <td class="edit"><a href="/commodityAuction/userAlter.jsp?buyerId=${buyer.buyerId}"><button onclick="btn_edit(1)"><i class="icon-edit bigger-120"></i>编辑</button></a></td>
...
<%--                        $(function() {--%>
<%--                            $.ajax({--%>
<%--                                url : "/commodityAuction/UserServlet",//要访问的后台地址--%>
...
<%--                                            +"<td class='delete'>"+"<button onclick='btn_delete(data[i].id)'>"+"<i class='icon-trash bigger-120'></i>删除</bttton></td>"--%>
<%--                                            +"</tr>"--%>
...
<%--        window.location="/commodityAuction/UserServlet?currentPage="+page+"&pageSize=${pageSize}";--%>
        window.location="/commodityAuction/UserServlet?currentPage="+page+"&pageSize=${pageSize}";
        }
