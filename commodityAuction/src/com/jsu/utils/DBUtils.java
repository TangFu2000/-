...
public class DBUtils {
    ...
    //类型参数，类型变量，类型可以变化 Teacher ,Student
    public static <T> List<T> getList(Class<T> clazz, String sql, Object...args)  {
        ...
        try{
            ...
            while (rs.next()){
                ...
                //循环rowMap给user所有属性赋值 entry{key,value},{username:"king"},{birthday:"2020-10-15"}
    ...
    //更新操作
    public static Integer rupdateForPrimary( String sql, Object...args)  {
