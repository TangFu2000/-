...
<div class="wrap" style="background: url(img/background.jpg) no-repeat center;">
    <div class="wpn">
        <div class="form-data pos">
            <a href="NewIndex.jsp"><img src="img/logo.png" class="head-logo"></a>
            <!--<p class="tel-warn hide"><i class="icon-warn"></i></p>-->
            <form action="/commodityAuction/RegisterServlet" method="post" id="myform">
                <p class="p-input pos">
                ...
                <p class="p-input pos">
                    ...
                    <span class="tel-warn tel-err "><font id="email_error"></font></span>
                </p>
